...
------
In a collaborative study with Hugo Le Roy and Martin Lenz, we developed a minimal model to describe the relaxation dynamics of gels with large cross-linkers - a materials configuration which canonically results in a broad distribution of stress relaxation times. We showed that multi-valent interactions between a pair of cross-linkers can significantly increase dissociation times, and that even a simple Poisson distribution of such multi-valent interactions in the system can result in a broad distribution of stress relaxation times. We then demonstrated that this model can capture the non-exponential stress relaxation exhibited by polymer hydrogels with nanoparticle or nanocage cross-linkers [1].
