...
In the future, I plan to leverage these experiences to establish new methods to study the complex mechanical properties of the extracellular matrix and tissues, understand how these mechanical properties guide tissue development and disease, and develop new solutions for in vitro disease modeling, tissue engineering, and regeneration.

Beyond these topics, I have prior research experience in computational polymer science as a BS student in the [Keten group](https://keten-group.northwestern.edu/) at Northwestern University, where I developed coarse-grained models to study the physics of polymer nanoconfinement. I also worked as a PhD research intern at Motif Foodworks where I worked on developing the mechanical properties of plant-based cheese, and have an ongoing interest in engineering food mechanics using techniques from soft matter science and materials science.
